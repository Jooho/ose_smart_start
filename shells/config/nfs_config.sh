...
export NFS_MOUNT_POINT=/exports/ose    #update 
export NFS_SERVER_TAG=infra            #update
export NFS_BLOCK_DEV=sdb               #update
export NFS_SERVER="aoappd-e-nfs002.ctho.asbn.gtwy.dcn" #update
