...
then
     oc process -f /usr/share/openshift/examples/infrastructure-templates/enterprise/metrics-deployer.yaml -v  HAWKULAR_METRICS_HOSTNAME=hawkular.${subdomain},USE_PERSISTENT_STORAGE=false  | oc create -f -
else
